...
export function InvoiceSendFromPreview({ invoiceId, hasCustomerEmail }: { invoiceId: string; hasCustomerEmail: boolean }) {
  ...
  function send() {
    ...
    startTransition(async () => {
      ...
      setSent(true);
      setTimeout(() => router.push(`/finanzen/${invoiceId}`), 1200);
    });
  }
