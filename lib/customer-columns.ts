...
export const CUSTOMER_COLUMNS_DEFAULT: ColumnConfig[] = [
  { key: "number", visible: true, order: 0, width: 110 },
  { key: "type", visible: true, order: 1, width: 100 },
  { key: "email", visible: true, order: 2, width: 200 },
  { key: "phone", visible: true, order: 3, width: 140 },
  { key: "city", visible: true, order: 4, width: 140 },
  { key: "customerSince", visible: true, order: 5, width: 120 },
  { key: "projectsCount", visible: true, order: 6, width: 90 },
  { key: "invoicesCount", visible: true, order: 7, width: 100 },
  { key: "address", visible: false, order: 8, width: 180 },
  { key: "zip", visible: false, order: 9, width: 90 },
];
